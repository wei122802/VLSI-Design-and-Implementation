...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _13190_archive_1.so
_13190_archive_1.so : archive.8/_13190_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_13190_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_13190_archive_1.so $@


ARCHIVE_OBJS += _13209_archive_1.so
_13209_archive_1.so : archive.8/_13209_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_13209_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_13209_archive_1.so $@
...
CU_UDP_OBJS = \
objs/udps/exIG1.o objs/udps/gSqMj.o 
