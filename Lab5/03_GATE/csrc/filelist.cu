...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _42876_archive_1.so
_42876_archive_1.so : archive.10/_42876_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_42876_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_42876_archive_1.so $@
...
CU_UDP_OBJS = \
objs/udps/exIG1.o objs/udps/Cpxa2.o 
