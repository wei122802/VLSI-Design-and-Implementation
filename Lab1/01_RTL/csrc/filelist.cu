...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _63929_archive_1.so
_63929_archive_1.so : archive.102/_63929_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_63929_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_63929_archive_1.so $@


ARCHIVE_OBJS += _63946_archive_1.so
_63946_archive_1.so : archive.102/_63946_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_63946_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_63946_archive_1.so $@
